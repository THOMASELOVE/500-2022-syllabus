...
All deadlines will be found on [the Course Calendar](https://thomaselove.github.io/500/calendar.html).
...
Instructions and supplemental materials for the Course Project [are available here](https://thomaselove.github.io/500-2022/project.html).
...
Instructions and supplemental materials for the OSIA work [are available here](https://github.com/THOMASELOVE/500-2022/tree/master/osia).

## Lab Assignments

Several lab assignments require you to do some analyses (using R and R Markdown) on data we will provide to you. 

Details on the lab assignments [are available here](https://github.com/THOMASELOVE/500-2022/tree/master/labs).
...
The essay prompts [are available here](https://github.com/THOMASELOVE/500-2022/tree/master/essays).
...
- If you have any concerns, raise them with us directly as soon as possible. Email to `500-help` at `case dot edu` is the best approach.
